...
public class Enums {
	...
	public enum MessageEnum {
		...
		CannotUpdateStage, UnFreezeRejected,GETMAXREQID,GETFILEFROMSERVER, GetExtensionStat,GETALLREPORTS,
		GETREPORTSLIST, GETALLREQUESTS, GETREQUESTSLIST,GETALLSTAGES,GETSTAGESLIST,GETALLUSERS,GETUSERSLIST;
